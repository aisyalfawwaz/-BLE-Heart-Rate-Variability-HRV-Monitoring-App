...
import com.example.starstec.databinding.ActivityScanBinding
import com.jakewharton.rxbinding4.view.clicks
import com.masselis.rxbluetoothkotlin.BluetoothIsTurnedOff
import com.masselis.rxbluetoothkotlin.DeviceDoesNotSupportBluetooth
import com.masselis.rxbluetoothkotlin.LocationServiceDisabled
import com.masselis.rxbluetoothkotlin.NeedBluetoothScanPermission
import com.masselis.rxbluetoothkotlin.NeedLocationPermission
        ...
        scanDisp = (getSystemService(BLUETOOTH_SERVICE) as BluetoothManager)
            ...
            .subscribe({
                ...
                when (it) {
                    ...
                    is NeedLocationPermission -> permissionLauncher.launch(Manifest.permission.ACCESS_FINE_LOCATION)
